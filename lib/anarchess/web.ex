defmodule Anarchess.Web do
  ...
  def get_game_with_comments!(id) do
    Repo.get!(Game, id)
  ...
  def create_game_move(game, attrs \\ %{}) do
    game
      |> Ecto.build_assoc(:moves)
      |> Move.changeset(attrs)
      |> Repo.insert
  end

  def create_game_comment(game, attrs \\ %{}) do
    game
